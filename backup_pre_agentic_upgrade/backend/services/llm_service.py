...
"""
    ...
    def _builtin_extractive_response(self, messages: List[Dict]) -> str:
        ...
        if "## Retrieved Context from Research Documents" in user_msg:
            ...
            if len(parts) == 2:
                ...
                for block in chunk_blocks:
                    block = block.replace("## Retrieved Context from Research Documents\n\n", "")
                    if block.strip():
        ...
        response_parts.append(
            ...
            "For AI-generated answers, install Ollama: `ollama serve` → `ollama pull llama3.2`*"
        )
